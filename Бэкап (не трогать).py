...
class AcoCars():
    ...
    def __init__(self, flags:list, blocks:list, s:int, f:int, a:int = 1, b:int = 1, p:float = 0.6, k:float = 42.5): # Инициализация объекта
        self.start = s
        self.finish = f
    ...
    def __new_ant_iteration(self) -> list:
        ...
        for i in range(2*N): # Столько же, сколько вершин
